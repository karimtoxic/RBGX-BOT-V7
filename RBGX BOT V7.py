...
def likes_plus(uid, region="ME"):
    url = f"https://ff-likes-gt-500.vercel.app/like?key=GT-500-LA&uid={uid}&region={region}"
    try:
...
def send_spam(uid):
    url = f"https://ff-spam-gt-500.vercel.app/spam?key=GT-500-KQ&uid={uid}"
    try:
        response = requests.get(url)
        if response.status_code == 200:
            data = response.json()
...
class Proxy:
    def __init__(self):
        self.username = "1"
        self.password = "1"
        self.website = "https://encryption-id-gt-500.vercel.app/encrypt?id={id}"
...
#################################
    ...
    def help14(self):
        helprbgx = f"120000018d0808{self.EncryptedPlayerid}101220022aa00408{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def fetch_data_from_url(self):
        ...
        data_url = "https://panel-gt-500.vercel.app/Uids"
        try:
